...
exports.findAll = function(req, res) {
	console.log("wines.findAll");
	var i = 0;
    db.collection('wines', function(err, collection) {
		console.log("wines.findAll collection = " + collection );
        collection.find().toArray(function(err, items) {		
			console.log("wines.findAll items = " + items);
			if(!err)
			{
				console.log("wines.findAll items after = " + i);
				res.send(items);
				
			}
			else{
				console.log("wines.findAll items after err = " + i);
				res.send(err);
			}
